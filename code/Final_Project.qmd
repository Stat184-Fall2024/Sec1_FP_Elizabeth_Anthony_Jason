...
library(dplyr)
library(tidyr)
data_math <- read.csv("../downloads/archive (1)/student-mat.csv")
data_port <- read.csv("../downloads/archive (1)/student-por.csv")
