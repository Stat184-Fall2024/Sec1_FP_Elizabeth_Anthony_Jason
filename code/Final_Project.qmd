...
###FAIR
Our data meets the FAIR principles because we state our dataset title and exact file name so that our readers can use the exact same dataset if they want for their own research. We have a detailed description of how we found our data and what we intended to use it for.

###CARE
Our data was collected through surveys in math and Portuguese language courses. It did not associate itself with American Indigenous groups.
