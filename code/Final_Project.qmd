...
ggplot(clean, aes(x = Walc)) +
  geom_histogram(breaks = seq(0, 5, by = 1), binwidth = 1, fill = "skyblue", color = "black") +
  labs(x = "Weekend Alcohol Consumption (Scale of 1-5)", y = "Frequency", title = "Histogram of Average Weekend Alcohol Consumption") +
  theme_minimal()
```
...
ggplot( # Set our axis and data
  ...
  geom_boxplot(size = .8) +
  labs( # Label our data
    x = "Weekend Alcohol Consuumption (Scale of 1-5)",
    y = "Average Grade",
